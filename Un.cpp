...
void scroll_note()	//welcome note
{
	...
	gotoxy(27,13);cout<<"MAYDAY ATM SERVICES";
	...
	gotoxy(56,23);cout<<"GAURAV    159887500485";
	gotoxy(56,24);cout<<"ASHUTOSH  160114737051";
	Sleep(2000);
...
void machine::help()		//initial help notice in mainmenu on opening account
{
	...
	gotoxy(3,24);
	cout<<"Contact at gauravjha150800@gmail.com";
...
void machine::note()	//final !!!
{
	system("color F0");
	gotoxy(10,3);
	cout<<"IN A GALAXY FAR FAR AWAY.. MAYDAY IS THERE ";gotoxy(10,7);
	...
	cout<<"CONTACT US AT : GAURAVJHA150800@GMAIL.COM";gotoxy(24,18);
